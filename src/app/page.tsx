      ...
      <div className="relative isolate">
        <div
          ...
          <div
            ...
            className='relative h-[calc(100vh-120px)] left-[calc(50%)] aspect-[16/9] w-full -translate-x-1/2 bg-rPS opacity-[0.30] sm:w-screen'
          />
        </div>
      </div>

      <MaxWidthWrapper className="h-[calc(100vh-130px)]">
